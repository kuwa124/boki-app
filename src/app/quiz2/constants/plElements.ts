...
export const plElements: Elements[] = [
  ...
  { id: 4, text: '発送費', answer: '費用' },
  { id: 5, text: '支払手数料', answer: '費用' },
  { id: 6, text: '旅費交通費', answer: '費用' },
  { id: 7, text: '減価償却費', answer: '費用' },
  { id: 8, text: '支払家賃', answer: '費用' },
  { id: 9, text: '支払地代', answer: '費用' },
  { id: 10, text: '保険料', answer: '費用' },
  { id: 11, text: '租税公課', answer: '費用' },
  { id: 12, text: '支払利息', answer: '費用' },
  { id: 13, text: '雑損', answer: '費用' },
  { id: 14, text: '固定資産売却損', answer: '費用' },
  { id: 15, text: '売上原価', answer: '費用' },
  { id: 16, text: '広告宣伝費', answer: '費用' },
  { id: 17, text: '貸倒引当金繰入', answer: '費用' },
  { id: 18, text: '貸倒損失', answer: '費用' },
  { id: 19, text: '通信費', answer: '費用' },
  { id: 20, text: '消耗品費', answer: '費用' },
  { id: 21, text: '水道光熱費', answer: '費用' },
  { id: 22, text: '修繕費', answer: '費用' },
