...
export default function Quiz2() {
  ...
  return (
    <main className='text-gray-600 min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500'>
      ...
      <div className='flex flex-col items-center space-y-2 max-w-2xl mx-auto text-white text-xs sm:text-lg '>
        <div className='flex sm:justify-between items-center min-w-32'>
          <p>収益：「受取○○」「○○益」</p>
          <p>例外）受取手形(資産)、受取商品券(資産)</p>
        </div>
        <div className='flex sm:justify-between items-center min-w-32'>
          <p>費用：「支払○○」「○○費」「○○料」「○○損」</p>
          <p>例外)損益(その他)</p>
